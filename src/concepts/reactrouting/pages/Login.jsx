    ...
    return (
        <div className='w-full h-screen flex justify-center items-center p-7'>
            <form  onSubmit={handleSubmit} className='w-[500px] h-[500px] rounded-xl  border-2 flex flex-col gap-3 p-10'>
                ...
                <button className='mt-3 cursor-pointer' onClick={handleSubmit}>Login</button>
                <div className='flex justify-between text-sm'>
                    <p className='text-gray-400 cursor-pointer'>Already have account</p>
                    <span className='text-purple-500 underline cursor-pointer'>Register</span>
                </div>
            </form>
        </div>
    )
